...
**코드 기준일**: 2026-03-28 (**Clean `start_project` Front Door** — `startProjectKickoffDoor.js`·decision short 직후·lineage **앞**; 정렬 본문: `buildStartProjectAlignmentSummary` in `startProjectSurfaceCopy.js`) · 원본 2026-03-23  

/**
 * External tool invocation body (W1): validation, pretrigger, emit_patch assembly hooks,
 * and live/artifact branch. Cursor lane specifics stay imported here; the public entry
 * `dispatchExternalToolCall.js` stays a thin facade.
 */
...
export async function runExternalToolInvocationFlow(spec, ctx = {}) {
